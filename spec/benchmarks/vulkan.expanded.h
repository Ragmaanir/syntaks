...
extern "C" {
# 31 "src/andesit/vulkan.h"
# 1 "src/andesit/vk_platform.h" 1
# 25 "src/andesit/vk_platform.h"
extern "C"
{
# 71 "src/andesit/vk_platform.h"
...
# 72 "src/andesit/vk_platform.h" 2
# 84 "src/andesit/vk_platform.h"
...
# 85 "src/andesit/vk_platform.h" 2





# 89 "src/andesit/vk_platform.h"
}
# 32 "src/andesit/vulkan.h" 2
# 66 "src/andesit/vulkan.h"
...
typedef void ( *PFN_vkCmdDrawIndexedIndirectCountAMD)(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride);
 ...
 void vkCmdDrawIndexedIndirectCountAMD(
    ...
    uint32_t maxDrawCount,
    uint32_t stride);
# 5491 "src/andesit/vulkan.h"
typedef struct VkTextureLODGatherFormatPropertiesAMD {
    VkStructureType sType;
    void* pNext;
    VkBool32 supportsTextureGatherLODBiasAMD;
} VkTextureLODGatherFormatPropertiesAMD;
# 5504 "src/andesit/vulkan.h"
...
# 6448 "src/andesit/vulkan.h"
typedef struct VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX {
    VkStructureType sType;
    void* pNext;
    VkBool32 perViewPositionAllComponents;
} VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX;
# 6461 "src/andesit/vulkan.h"
...
typedef VkResult ( *PFN_vkGetMemoryHostPointerPropertiesEXT)(VkDevice device, VkExternalMemoryHandleTypeFlagBitsKHR handleType, const void* pHostPointer, VkMemoryHostPointerPropertiesEXT* pMemoryHostPointerProperties);
